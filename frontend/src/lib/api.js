...
export const ordersAPI = {
  ...
  // JP 2026-06-13: cambia n. persone → ricalcola coperto
  setCovers:  (id, covers)    => api.patch(`/orders/${id}/covers`, { covers }),
...
export const publicAPI = {
  menu:       (slug, lang, bar, takeaway) => publicApi.get(`/public/menu/${slug}`, { params: { ...(lang ? { lang } : {}), ...(bar ? { bar: 1 } : {}), ...(takeaway ? { takeaway: 1 } : {}) } }),
